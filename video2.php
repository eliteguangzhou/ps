...
$(document).ready(function () {
  $.colorbox({href:"popupmail.php?n=2",width:500,height:300,overlayClose:false});
});
</script>
<?php } ?>
  </head>
...
color: gray;
padding-left: 400px;"> Video 2/3</span>
<!-- 	<iframe width="640" height="390" src="http://www.youtube.com/embed/Brb-gPMDlps?<?php if (isset($_GET['email'])) echo "autoplay=1;controls=0"; ?>" frameborder="0" allowfullscreen></iframe> -->
<!-- 	<img src="images/video2.jpg" width="560"> -->
<!-- 	<img src="images/video3.jpg" width="560"> -->
	<div>
<h1>    Laissez vos commentaires: </h1>
    <br/>
    <form action="video2.php" method="get">
	...
	<?php
	$sql = "SELECT * 
  FROM  `video_comments` WHERE `numero` = 2 ORDER BY  `video_comments`.`id` DESC 
  LIMIT 0 , 30";
...
color: gray;">1</span><a href="video1.php?email=<?php echo $_GET['email'];?>"><img src="images/video.png">
	...
	<div>
	   <span style="font-size: 100;
color: gray;">2</span><a href="video2.php?email=<?php echo $_GET['email'];?>">
	<img src="images/video.png">
	</a>
	</div>	
	<div>
	   <span style="font-size: 100;
color: gray;">3</span><a href="video3.php?email=<?php echo $_GET['email'];?>">
	<img src="images/video.png">
	</a>
      </div>
    </div>
