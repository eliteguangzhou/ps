...
<?php echo tep_draw_infoBox_bottom();?>
		...
		?>
			<table cellpadding="0" cellspacing="0" border="0" width="100%"> 
                            ...
                            <tr>
                            <td style="padding-bottom:15px;" width="100%"><?php echo tep_draw_separator('pixel_black.gif'); ?></td>
                          </tr>
                            <tr>
                          <td style="font-size:16px">                          
                            <b><?php if ($language == 'french') echo CONTACT_SERVICE_CLIENT;?><br/></b>
                          </td>
                          </tr>
                          <tr>
                            <td style="padding-top:15px;" width="100%"><?php echo tep_draw_separator('pixel_black.gif'); ?></td>
                          </tr>
