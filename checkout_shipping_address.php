    ...
    if (tep_not_null($HTTP_POST_VARS['firstname']) && tep_not_null($HTTP_POST_VARS['lastname']) && tep_not_null($HTTP_POST_VARS['street_address'])) {
      ...
      if (strlen($postcode) < ENTRY_POSTCODE_MIN_LENGTH) {
        ...
        if (strlen($postcode) == 5 && in_array(substr($postcode,0, 2), $blocked_postcode) && in_array($country, $blocked_countries)) {
          ...
          $messageStack->add('checkout_address', ENTRY_POST_CODE_ERROR2);
        }
...
<!-- body_text //-->
    ...
    <td width="100%" class="col_center"><?php echo tep_draw_form('checkout_address', tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL'), 'post', 'onSubmit="return check_form_optional(checkout_address);"'); ?>
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
...
<?php echo tep_draw_infoBox_top();?>
                	...
                	<table border="0" width="100%" cellspacing="0" cellpadding="2">
					  ...
					  <tr>
						...
						<td class="main" width="100%" valign="top"><?php echo TEXT_SELECTED_SHIPPING_DESTINATION; ?></td>
					  </tr>
					  <tr>
						<td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
						<td align="right" width="100%" valign="top">
								...
								<table border="0" cellspacing="0" cellpadding="2">
								  <tr>
									...
									<td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
									<td class="main" valign="top" width="70%"><?php echo tep_address_label($customer_id, $sendto, true, ' ', '<br>'); ?></td>
									<td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
								  </tr>
								</table>
						</td>
...
<?php
	  ...
	  $addresses_query = tep_db_query("select address_book_id, entry_digicode as digicode, entry_firstname as firstname, entry_lastname as lastname, entry_company as company, entry_street_address as street_address, entry_suburb as suburb, entry_city as city, entry_postcode as postcode, entry_state as state, entry_zone_id as zone_id, entry_country_id as country_id from " . TABLE_ADDRESS_BOOK . " where customers_id = '" . (int)$customer_id . "'");
...
<?php echo tep_draw_infoBox_top();?>
                ...
                <table border="0" width="100%" cellspacing="0" cellpadding="2">
					  <tr>
						...
						<td class="main vam" align="right"><?php echo tep_draw_hidden_field('action', 'submit') . tep_image_submit('button_continue.gif', IMAGE_BUTTON_CONTINUE); ?></td>
						<td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
					  </tr>
				</table>
