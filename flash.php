...
<?php
  $specials_query_raw = "select
      ...
      DATEDIFF(expires_date, '".date('Y-m-d H:i:s')."') as days_left,
      TIMEDIFF(expires_date, '".date('Y-m-d H:i:s')."') as time_left,
      p.item_size,
      pd.Item_size,
      cd.categories_name,
    ...
    where s.expires_date >= '".date('Y-m-d H:i:s')."'
    and s.category = 'flash'
