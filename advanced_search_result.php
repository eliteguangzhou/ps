...
// create column list
  ...
  $select_str = "select distinct " . $select_column_list . " m.manufacturers_id, p.item_size, pd.Gender, p.products_id, pd.products_name, pd.products_description, cd.categories_name, p.products_price, p.products_tax_class_id, IF(s.status, s.specials_new_products_price, NULL) as specials_new_products_price, IF(s.status, s.specials_new_products_price, p.products_price) as final_price ";
  ...
  $where_str = " where cd.categories_id = p2c.categories_id AND cd.language_id = ".(int)$languages_id." AND p.products_status = '1' and p.products_id = pd.products_id and pd.language_id = '" . (int)$languages_id . "' and p.products_id = p2c.products_id and p2c.categories_id = c.categories_id ";
