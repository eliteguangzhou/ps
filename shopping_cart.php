...
<body marginwidth="0" marginheight="0" topmargin="0" bottommargin="0"
		...
		<div id="block_popup">
			<center>
				...
				?>
					<hr />
					<br>
					<form action="<?php echo tep_href_link(FILENAME_SHOPPING_CART);?>"
						method="POST" id="submit_gifts" style="display: none">
						<div>
						<?php echo $max_gifts > 1 ? CHOOSEN_GIFTS . ' (<span id="gifts_left"></span> '.GIFTS_LEFT.')' : CHOOSEN_GIFT;?>
						</div>
						<br>
						<div id="gift_content" class="product"></div>
						<br> <input type="hidden" id="gifts" name="gifts" value="" /> <input
							type="reset" value="<?php echo IMAGE_BUTTON_CANCEL;?>"
							onclick="resetGifts();" /> <input type="submit"
							value="<?php echo IMAGE_BUTTON_CONTINUE;?>" />
					</form>
				</div>
			</center>
			<div class="clear"></div>
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0">
		<tr>
			...
			<!-- body_text //-->
			<td width="100%" class="col_center"><?php tep_draw_heading_top(901);?>

			<?php new contentBoxHeading_ProdNew($info_box_contents);?> <?php tep_draw_heading_top_1();?>
			<?php echo tep_draw_form('cart_quantity', tep_href_link(FILENAME_SHOPPING_CART, 'action=update_product')); ?>
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						if ($total > 0) {
							...
							<table cellpadding="0" cellspacing="0">
								<tr>
									<td class="messageStackError"><img
										src="<?php echo DIR_WS_IMAGES?>/icons/error.gif" alt="Erreur"
										title=" Erreur " border="0" height="10" width="10"> <?php echo constant($cart_error); ?>
									</td>
								</tr>
								<tr>
									<td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?>
					...
					<table cellpadding="0" cellspacing="10" border="0">
						<tr>
							...
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td class="stockWarning" align="center"><br> <?php echo OUT_OF_STOCK_CAN_CHECKOUT; ?>
									</td>
								</tr>
							</table> <?php
								} else {
							...
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td class="stockWarning" align="center"><br> <?php echo OUT_OF_STOCK_CANT_CHECKOUT; ?>
									</td>
								</tr>
							</table> <?php
								}
							...
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td class="cart_line_x"><?php echo tep_draw_separator('spacer.gif', '1', '1'); ?>
									</td>
								</tr>
							</table>
							...
							<table cellspacing="0" cellpadding="0" border="0" class="product">
								...
								<tr>
									<td style="vertical-align: middle"><?php if ($cart->count_gifts('min') == 0) {echo $promo_nb; /*if ($total < 3) new contentBox($info_box_contents2, false);*/}?>
									</td>
									<td><table cellspacing="0" cellpadding="0" border="0">
											<tr>
												<td width="80%" align="right" class="cart_total_left" nowrap>
													<strong><?php echo SUB_TITLE_SUB_TOTAL; ?> </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
												<td width="20%" align="center" class="cart_total_right"><span
													class="productSpecialPrice"><?php echo $currencies->format($cart->show_total()); ?>
												</span>
												</td>
											</tr>
											<?php
											...
											<tr>
												...
												<td width="20%" align="center" class="cart_total_right"><span
													class="productSpecialPrice">-<?php echo $currencies->format($discount['amount']); ?>
												</span>
												</td>
											</tr>
											<?php }
											...
											<tr>
												...
												<td width="20%" align="center" class="cart_total_right"><span
													class="productSpecialPrice">-<?php echo $currencies->format($nb_discount_cart); ?>
												</span>
												</td>
											</tr>
											<?php }
											...
											<tr>
												...
												<td width="20%" align="center" class="cart_total_right"><span
													class="productSpecialPrice">-<?php echo $currencies->format($discount_cart); ?>
												</span>
												</td>
											</tr>
											<?php }
											...
											<tr>
												...
												<td width="20%" align="center" class="cart_total_right"><span
													class="productSpecialPrice"><?php echo $fp <= 0 ? FREE_SHIPPING_COST : $currencies->format($fp); ?>
												</span>
												</td>
											</tr>
											<tr>
												...
												<td width="20%" align="center" class="cart_total_right"><span
													id="order_total" class="productSpecialPrice"><?php echo $currencies->format($total_cart <= 0 ? 0 : $total_cart); ?>
												</span>
												</td>
											</tr>
										</table></td>
							...
							<table cellspacing="0" cellpadding="0" border="0">
								<tr>
									...
									<?php echo tep_image_submit('button_update.gif', IMAGE_BUTTON_UPDATE_CART, ' id="update_cart_submit" '); ?>
									<?php
							...
							</table> <?php if (ACTIVATE_DISCOUNT) include (DIR_WS_MODULES.'easy_coupons_box.php'); ?>
							...
							<table cellpadding="0" cellspacing="0">
								<tr>
									<td class="messageStackError"><img
										src="<?php echo DIR_WS_IMAGES?>/icons/error.gif" alt="Erreur"
										title=" Erreur " border="0" height="10" width="10"> <?php echo $cart_error; ?>
									</td>
								</tr>
								<tr>
									<td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?>
							...
							<table border="0" cellspacing="0" cellpadding="2">
								<tr>
									<td></td>
									<td align="center" width="100%"><br> <?php new infoBox_77(array(array('text' => TEXT_CART_EMPTY))); ?>
									</td>
									<td></td>
								</tr>
								<tr>
									<td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?>
									</td>
									<td align="right" class="main" width="100%"><?php echo '<a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . tep_image_button('button_continue.gif', IMAGE_BUTTON_CONTINUE) . '</a>'; ?><br>
										<br></td>
									<td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?>
									</td>
								</tr>
				...
				</form> <?php tep_draw_heading_bottom_1();?> <?php tep_draw_heading_bottom();?>
			</td>
			<!-- body_text_eof //-->
			<td class="col_right">
...
<script
	...
	src="http://img.netaffiliation.com/u/31/p13233.js?zone=panier&montant=<?php echo $cart->show_total(false)*$currencies->currencies[$currency]['value']/1.196;?>&listeids=<?php echo $products_ids;?>"></script>
