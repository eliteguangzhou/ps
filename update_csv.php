...
//if (!empty($_POST) && $_POST['log23'] = 'admin' && $_POST['pass97'] == 'CurL2010') {
    ...
    $fields = array (
        ...
        'URL produit' => "CONCAT('http://www.parfumseduction.com/product_info.php?products_id=', p.products_id)",
    ...
    $fields = array (
        ...
        'Lien' => "CONCAT('http://www.parfumseduction.com/product_info.php?products_id=', p.products_id)",
    ...
    $query = tep_db_query("
        SELECT ".str_replace('products_name', 'CONCAT(products_name, " ", products_model)',
                ...
                str_replace('pd.products_id', "CONCAT('http://www.parfumseduction.com/product_info.php?products_id=', pd.products_id)",
                join(',', $fields))))."
        FROM `products` p, products_description pd, manufacturers m
        WHERE pd.products_id = p.products_id
        and pd.language_id = 5
    ...
    $fields = array (
        ...
        'URL' => "CONCAT('http://www.parfumseduction.com/product_info.php?products_id=', pd.products_id)",
    ...
    $fields = array (
        ...
        'description' => 'products_description',
        'prix' => 'products_price',
        'URL_produit' => "CONCAT('http://www.parfumseduction.com/product_info.php?products_id=', p.products_id)",
    ...
    $fields = array (
        ...
        'manufacturer' => 'm.manufacturers_name as manufacturer',
        'description' => 'products_description',
        'link' => "CONCAT('http://www.parfumseduction.com/product_info.php?products_id=', p.products_id)",
