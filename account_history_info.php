    ...
    <td width="100%" valign="top"><table border="0" summary="" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
          ...
          <?php if (!empty($order->info['tracking_number'])) { ?>
          <tr>
            <td colspan="2"><?php echo HEADER_TRACKING . ' ' . $order->info['tracking_number']; ?></td>
          </tr>
          <?php } ?>
        </table></td>
      </tr>
      ...
      <tr>
        <td><table border="0" summary="" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td class="main"><?php echo ACCOUNT_HISTORY_FACTURER; ?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
?>
            <td width="30%" valign="top"><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
              <tr>
...
?>
            <td width="<?php echo (($order->delivery != false) ? '70%' : '100%'); ?>" valign="top"><table border="0" summary="" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
<?php
      ...
      <tr>
        <td><table border="0" summary="" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            ...
            <td width="70%" valign="top"><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
<?php
