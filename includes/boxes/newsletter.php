...
<tr><td align="center" class="aerer2">
  ...
  <tbody><tr>
    <td><?php echo tep_image(DIR_WS_IMAGES.'box_corn_l_3.gif','','','','style="background:white;"'); ?></td>
    <td style="width:100%;" class="box_heading_td_3"></td>
    <td><?php echo tep_image(DIR_WS_IMAGES.'box_corn_r_3.gif','','','','style="background:white;"'); ?></td>
  </tr>
</tbody></table>
