...
define('MY_SPONSORSHIP_TITLE', 'Patrocinio');
define('MY_SPONSORSHIP_ADD', 'Patrocinador un amigo');
define('MY_SPONSORSHIP_LIST', 'Mis Mentores');
define('MY_SPONSORSHIP_DISCOUNT', 'Mis recortes');
?>
