...
define('MY_SPONSORSHIP_TITLE', 'Sponsorship');
define('MY_SPONSORSHIP_ADD', 'Invite a friend');
define('MY_SPONSORSHIP_LIST', 'My godchildren');
define('MY_SPONSORSHIP_DISCOUNT', 'My cuts');
?>                             
