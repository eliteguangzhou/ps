...
define('TEXT_ENTER_PAYMENT_INFORMATION', 'This is currently the only payment method available to use on this order.<br><br>');
...
define('SECURE_PAYMENT', 'Logo Secure payment');
define('HSBC_LOGO', 'Logo HSBC');
define('SECURE_TEXT', 'You will be redirected to a space');
