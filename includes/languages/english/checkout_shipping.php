...
define('EXPEDITION_TYPE_LABEL', 'Shipping method');
define('EXPEDITION_TYPE_VALUE', 'DPD / Chronopost');
define('EXPEDITION_DELAY_LABEL', 'Time');
define('EXPEDITION_DELAY_VALUE', 'Delivery within 8-12 days');
define('WARNING_NOT_SHIPPABLE', 'Warning! Your country of delivery is no longer available.');
?>                                                      