...
define('SUB_TITLE_FRAIS_PORT', 'Costo de envío :');
...
define('STR_GIFT_CHOOSE', '<script type="text/javascript">document.write(\'<br /><br />Usted prefiere un regalo diferente?<br /><a href="'.tep_href_link(FILENAME_SHOPPING_CART).'#" onclick="document.getElementById(\\\'popup\\\').style.display = \\\'block\\\'">Haga clic aquí!</a>\');</script>');
...
');
define('SPECIAL_PROMO1', 'Compre 2 artículos y paga sólo 7 euros gastos de envío.');
