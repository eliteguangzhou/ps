...
define('EXPEDITION_TYPE_LABEL', 'Forma de envío');
define('EXPEDITION_TYPE_VALUE', 'DPD / Chronopost');
define('EXPEDITION_DELAY_LABEL', 'Plazo');
define('EXPEDITION_DELAY_VALUE', 'Entrega entre 8 y 12 días hábiles');
define('WARNING_NOT_SHIPPABLE', '·Atención! Su país de entrega ya no está disponible.');
?>