...
define('HEADER_TITLE_MENTIONS_LEGALES', 'Legale');
...
define('BOX_INFORMATION_CANCEL', 'Cancellazioni');
define('BOX_INFORMATION_TRACK', 'Stato dell\'ordine');
...
define('TEXT_EN_STOCK', '<span class="en_stock">Disponibile</span>');
...
define('YOUR_PROMO_CODE', 'Codice regalo :');
define('ERROR_PRODUCT_REQUIRED', 'È necessario almeno un prodotto nel carrello per utilizzare questo codice regalo.');

define('MENU_GIFT', 'Speciale del mese');
define('MENU_VALENTIN', 'Consigli');

define('IMAGE_BUTTON_CANCEL', 'Annullare');
