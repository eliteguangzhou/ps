...
define('TEXT_ORDER_NUMBER', '<b>Order Number: </b>');
define('TEXT_TITRE','<br><center><b>VIEW YOUR ORDER RECEIPT BELOW</b></center><br>');

define('TEXT_SUCCESS_HIGH', 'Your order was successful sent ! We will review it and send you an email to confirm the order. If all looks good, we will then contact you within 24
