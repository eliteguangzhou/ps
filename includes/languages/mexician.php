...
define('BOX_INFORMATION_TRACK', 'Seguimiento de su pedido');
define('BOX_INFORMATION_FAQ', 'Preguntas más frecuentes');
...
define('meilleurs_marques', 'Las mejores marcas');
...
define('MENU_FRAGRANCE_WOMEN', 'Mujer Perfumes');
define('MENU_FRAGRANCE_MEN', 'Hombre Perfumes');
define('MENU_ALL_BRANDS', 'Todas nuestras marcas');
...
define('YOUR_PROMO_CODE', 'Don código :');
define('ERROR_PRODUCT_REQUIRED', 'Necesita al menos un producto en el carrito de usar este don código.');

define('MENU_VALENTIN', 'Nuestra selección');
