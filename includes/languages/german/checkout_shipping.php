...
define('EXPEDITION_TYPE_LABEL', 'Versandart');
define('EXPEDITION_TYPE_VALUE', 'DPD / Chronopost');
define('EXPEDITION_DELAY_LABEL', 'Frist');
define('EXPEDITION_DELAY_VALUE', 'Lieferung innerhalb von 8 bis 12 Werktagen');
define('WARNING_NOT_SHIPPABLE', 'Warnung! Dein Land der Lieferung ist nicht mehr verfügbar.');
?>