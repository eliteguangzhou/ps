...
define('TEXT_SELECT_PAYMENT_METHOD', 'Veuillez choisir la méthode préférée de paiement à utiliser pour cette commande.');
...
define('SECURE_PAYMENT', 'Logo paiement sécurisé');
define('HSBC_LOGO', 'Logo HSBC');
define('SECURE_TEXT', 'Vous allez être redirigé vers un espace de');
