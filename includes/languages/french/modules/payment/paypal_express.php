...
*/
  ...
  define('MODULE_PAYMENT_PAYPAL_EXPRESS_TEXT_TITLE', 'PayPal Paiement Express');
  define('MODULE_PAYMENT_PAYPAL_EXPRESS_TEXT_PUBLIC_TITLE', 'Carte de cr&eacute;dit');
  ...
  define('MODULE_PAYMENT_PAYPAL_EXPRESS_TEXT_BUTTON', 'Payer par PayPal');
