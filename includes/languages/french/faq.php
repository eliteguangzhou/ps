...
Nous recevons chaque jours des centaines de questions. Afin de faciliter l\'acc�s &agrave; l\'information, nous avons list&eacute;
...
<h1>LES PRODUITS</h1>
<h3>
1. Vous ne trouvez pas le parfum que vous d&eacute;sirez?
</h3>
...
�tant donn&eacute; que�nos arrivages ne sont jamais les�m�mes, nous vous invitons &agrave; vous connecter le plus souvent
...
fid&eacute;lit&eacute; de nos clients.

Nous vous rappelons que la vente de produits contrefaits est passible d\'une
peine d\'emprisonnement de 5 ans et d\'une amende pouvant atteindre 500 000 &euro;.
<h3>
3. Que se passe-til lorsqu\'un produit est en rupture de stock?
</h3>
Lorsqu\'un produit est en rutpure de stock, nous vous cr&eacute;ons un avoir du montant du(des) produit(s) ainsi qu\'un
bon d\'achat de 8 euros pour partager vos frais de livraison (ce bon d\'achat n\'est accord&eacute; que dans ce cas
pr&eacute;cis).
<h3>
...
magasin. Cependant, il se peut que certains prix soient les m�mes ou plus chers mais
cela reste une minorite. Pour ce dernier cas, la raison est que notre fournisseur ne nous
fournit pas ce produit &agrave; un prix int&eacute;ressant et dans la mesure o� on applique une formule
...
<br/>2.Ajoutez vos produits &agrave; votre panier en cliquant sur " AJOUTER "
...
Nous vous remercions d\'indiquer tr�s pr&eacute;cis&eacute;ment le nom de votre commune ainsi que votre code postal.
Veillez &agrave; bien orthographier le nom de la ville de livraison : les abr&eacute;viations, fautes d\'orthographe et autres
coquilles peuvent parfois entra�ner des erreurs dans cette rubrique.�Pensez aussi &agrave; pr&eacute;ciser les informations
suivantes�: code d\'acc�s, &eacute;tage, immeuble.�
<h3>
...
La transaction sera r&eacute;alis&eacute;e de fa�on s&eacute;curis&eacute;e par le biais du service de paiement de paypal.�
...
heure apr�s le passage de la commande".
<h3>
4. Que faire si j\'ai oubli&eacute; d\'ins&eacute;rer le code cadeau/ code r&eacute;duction� ?
</h3>
Puisque les commandes se font automatiquement d�s la validitation, nous ne pouvons ajouter les cadeaux &agrave;
...
Vous pouvez suivre votre commande sur notre site gr�ce &agrave; votre num&eacute;ro de commande figurant dans votre
e-mail de confirmation d\'exp&eacute;dition.��
Apr�s le traitement et l\'exp&eacute;dition de votre commande, vous recevrez un e-mail. Celui-ci indique votre num&eacute;ro
...
compte, l\'offre promotionnelle appara�tra dans votre panier de commande
<h3>
6. Pouvez-vous nous envoyer des &eacute;chantillons� ?
</h3>
Nous n\'offrons pas d\'&eacute;chantillons &agrave; vous proposer &agrave; l\'heure actuelle. Cependant, nous faisons r&eacute;guli�rement des
offres tr�s int&eacute;ressantes tels que des cadeaux (gels douche, cr�mes etc).
...
<h3>
7. Je n\'ai pas re�u ma commande est-ce normal� ?
</h3>
Nous livrons dans un d&eacute;lai de 8 &agrave; 12 jours ouvr&eacute;s. Veuillez suivre r&eacute;guli�rement votre colis &agrave; l\'aide de votre
...
<table style="text-align:center;" border="1" width="75%">
    <tr>
        <td>
            Nombre de produits achet&eacute;s
        </td>
        <td>
            Frais de port
        </td>
        <td>
            R&eacute;duction imm&eacute;diate
        </td>
    </tr>
    <tr>
        <td>
...
Vous payez vos parfums &agrave; prix co�tant. Il n\'y a aucun frais de structure, de frais marketing, ni de taxes ou
autres.
<h3>
3. Que se passe-t-il lorsqu\'un colis est retourn&eacute;� ?
</h3>
Lorsqu\'un colis est retourn&eacute;, cela peut prendre jusqu\'&agrave; 45 jours pour qu\'un colis revienne dans nos entrep�ts.
D�s r&eacute;ception du colis nous vous proposons soit un avoir du montant de votre commande, soit une r&eacute;exp&eacute;dition
...
<!-- <a href="http://\'.$_SERVER[\'SERVER_NAME\'].\'">\'.STORE_NAME.\'</a> -->
