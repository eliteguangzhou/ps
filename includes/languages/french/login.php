...
define('TEXT_NEW_CUSTOMER', 'Vous êtes nouveau client sur '.STORE_NAME.' ?');
define('TEXT_NEW_CUSTOMER_INTRODUCTION', 'Veuillez cliquer sur le bouton "Continuer" pour créer un compte. <br /><br />En créant votre compte sur ' . STORE_NAME . ', vous pourrez faire vos achats plus rapidement et suivre vos commandes.');

define('HEADING_RETURNING_CUSTOMER', 'Vous avez déjà un compte ?');
define('TEXT_RETURNING_CUSTOMER', 'Identifiez-vous pour y accéder.  ');

define('TEXT_PASSWORD_FORGOTTEN', 'Vous avez oublié votre mot de passe ? Cliquez ici.');

define('TEXT_LOGIN_ERROR_IN_LOGIN', 'Erreur : Cette adresse email n\'est pas enregistrée sur notre site.');
...
define('FROM_SPONSORSHIP', 'Pour profiter du système de parrainage, vous devez vous authentifiez.

2 bonnes raisons de parrainer vos amis !

1. C\'est simple !
Pour parrainer vos amis, il vous suffit d\'entrer leurs emails dans les champs ci-dessous. Un email leur sera envoyé les informant de votre invitation.

2. Ca rapporte des euros !
'.STORE_NAME.' vous offre une rémunération exceptionnelle déclinée sur 3 niveaux qui vous permet de gagner des euros :
