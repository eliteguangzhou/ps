...
define('HEADER_NEW_DISCOUNT', '<a href="'.tep_href_link('sponsorship_discount.php').'" id="new_discount">Neue Discount-Code! Klicken Sie hier !</a>');
define('HEADER_NEW_DISCOUNTS', '<a href="'.tep_href_link('sponsorship_discount.php').'" id="new_discount">Neue Discount-Codes! Klicken Sie hier !</a>');
...
define('BOX_SHOPPING_CART_EMPTY', ' Produkte');
...
define('BOX_INFORMATION_CONDITIONS', 'Impressum');
...
define('BOX_INFORMATION_SHIPPING_DETAILS', 'AGB');
define('BOX_INFORMATION_RETURNS', 'Rücksendungen');
define('BOX_INFORMATION_CANCEL', 'Stornierungen');
define('BOX_INFORMATION_TRACK', 'Verfolgen der Bestellungen');
...
define('ENTRY_EMAIL_ADDRESS_CONFIRM', 'Die E-Mail-Adresse bestätigen::');
define('ENTRY_EMAIL_ADDRESS_CONFIRM_ERROR', 'Ihre Bestätigung der E-Mail-Adresse weicht von Ihrer E-Mail-Adresse ab.');
...
define('ENTRY_DIGICODE', 'Zugangscode :');
...
define('Our_Best_Candles', 'Unsere schönsten Kerzen');
define('Our_Best_P_Her', 'Besten Damenparfums');
define('Our_Best_P_Him', 'Besten Herrenparfums');
define('Skin_Care', 'Besten Hautpflegeprodukte');
define('Nos_meilleurs_coffrets_w', 'Besten Sets für Damen');
define('Nos_meilleurs_coffrets_m', 'Besten Sets für Herren');
define('meilleurs_marques', 'Die besten Marken');
define('Nos_marques', 'Unsere Marken');
...
define('HEADER_HELLO', 'Willkommen');
define('HEADER_LOGIN', 'Die Kennung eingeben');
define('HEADER_LOGOUT', 'Sich auswählen');
define('CHOOSE_YOUR_CAT', 'Klicken Sie bitte auf die Kategorie Ihrer Wahl:');
define('CHOOSE_YOUR_BRAND', 'Klicken Sie bitte auf die Marke Ihrer Wahl: ');



define('TEXT_DISPLAY_NUMBER_OF_RANGES', '<b>%d</b> bis <b>%d</b> anzeigen (bei <b>%d</b> Produktreihen)');
define('TEXT_INSTEAD_OF', 'Anstelle von');
define('TEXT_EN_STOCK', '<span class="en_stock">vorrätig</span>');

define('MENU_HOME', 'Heim');
define('MENU_FRAGRANCE_WOMEN', 'Fraulich Fragrances');
define('MENU_FRAGRANCE_MEN', 'Männlich Fragrances');
define('MENU_ALL_BRANDS', 'Alle unsere Marken');
define('MENU_MY_ACCOUNT', 'Ihr Konto');
define('MENU_CHRISTMAS', 'Special Christmas');
define('MENU_MONTHLY', 'Special des Monats');
define('MENU_SPONSORSHIP', 'Sponsoring');
define('MENU_CONTACT', 'Kontakt');
define('MENU_FLASH', 'Flash-Verkauf');

define('OTHERS_LIST_PRODUCTS', 'Weitere Produkte im Bereich');
...
$tmp = $tmp[date('D')];
define('MENU_DAILY', 'Promotion '.$tmp);

define('FOR_HIM', '<span class="for_him">Für Ihn</span>');
define('FOR_HER', '<span class="for_her">Für Sie</span>');
define('FOR_UNISEX', '<span class="for_him">Uni</span><span class="for_her">sex</span>');
define('FOR_HIM_STR', 'Für Ihn');
define('FOR_HER_STR', 'Für Sie');
define('FOR_UNISEX_STR', 'Unisex');
define('TEXT_SAVING', 'Sichern ');

define('PRICE_TIMER', 1.25);
define('PRICE_ADDER', 19);

define('YOUR_PROMO_CODE', 'Ihr Geschenk-Code :');
define('ERROR_PRODUCT_REQUIRED', 'Sie müssen mindestens ein Produkt in den Einkaufswagen zu benutzen dieses Geschenk-Code.');

define('MENU_VALENTIN', 'Unsere Auswahl');

define('IMAGE_BUTTON_CANCEL', 'Stornieren');
define('PAYEMENT_100_SECURE', '100% sichere Zahlung');
