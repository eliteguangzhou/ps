...
$my_col = 0;
  ...
  if ($listing_split->number_of_rows > 0) {
    ...
    while ($listing = tep_db_fetch_array($listing_query)) {
        ...
        $link = tep_href_link(FILENAME_DEFAULT, $array[0].'&cPath2='.$listing['products_id'] . $array[1].'&name2='.rewrite_name($listing['Gamme']));
        ...
        for ($col=0, $n=sizeof($column_list); $col<$n; $col++) {
            ...
            switch ($column_list[$col]) {
              ...
              case 'PRODUCT_LIST_NAME':
                $lc_align = '';
                $p_name = $lc_text = '<a href="' . $link . '">' . $listing['Gamme'] . '</a>';
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid #FFFFFF; border-width:0 15px 0 0;">
                            <table cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td style="height:47px " align="center" valign="middle" ><a href="' . $link.'">'.tep_image_button("button_products_list.gif").'</a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
