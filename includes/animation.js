...
$(document).ready(function() {
    var anim = [['blink'], ['fadeOut'], ['fadeOut'], ['fadeOut'], ['fadeOut']];
    var id = ['right_ban', 'flash_title', 'daily_title', 'promo_nb1', 'choose_gift'];
    ...
    if (typeof(c_img_p) != "undefined")
        alternate(["img_p", "img_pp", "img_ppp", "img_pppp"], "img_pp", 5000);
