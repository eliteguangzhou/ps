...
<!-- body_text //-->
    <td width="100%" class="col_center"><?php echo tep_draw_form('product_reviews_write', tep_href_link(FILENAME_PRODUCT_REVIEWS_WRITE, 'action=process&products_id=' . $HTTP_GET_VARS['products_id']), 'post', 'onSubmit="return checkForm();"'); ?><table border="0" width="100%" cellspacing="0" cellpadding="0"><tr><td>
...
?>
      <table cellpadding="0" cellspacing="0" border="0">
	  	<tr><td><?php echo $messageStack->output('review'); ?></td></tr>
...
?>
												<table cellpadding="0" cellspacing="0" border="0">
                                                    ...
                                                    <tr><td align="center" class="pic"><br style="line-height:1px;"><br style="line-height:5px;">
...
<br style="line-height:1px;"><br style="line-height:15px;"></td></tr>
...
?>
					...
					<td width="30"></td>
						<td align="center" class="vam"> <a href="<?php tep_href_link(basename($PHP_SELF), tep_get_all_get_params(array('action')) . 'action=buy_now')?>"><?php tep_image_button('button_add_to_cart.gif', IMAGE_BUTTON_IN_CART)?></a></td>
					  </tr>
