...
*/
  ...
  // si la commande dépasse 500€ alors paiment special
/*
            ...
            <table class="table_checkout_payment">
                <tr>
                    <td>
                        ...
                        <img class="hsbc_img" src="<?php echo DIR_WS_IMAGES; ?>/HSBC1.jpg" valign="middle" alt="<?php echo HSBC_LOGO; ?>" /> <div class="hsbc_text">Attention, l'usage frauduleux du n° de Carte Bancaire d'une autre personne sans son consentement constitue juridiquement un délit d'escroquerie réprimé par l'article 313.1 du code pénal par une peine de 5 ans d'emprisonnement et 382 000 euros d'amende.</div>
                        <?php } ?>
                    </td>
                </tr>
            </table>
