...
?>
      <tr>
        <td><table border="0" summary="" cellspacing="0" cellpadding="2">
          <tr>
...
<?php if (SPONSORSHIP_ACTIVATE) {?>
      <tr>
        <td><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main"><b><?php echo MY_SPONSORSHIP_TITLE; ?></b></td>
          </tr>
        </table></td>
      </tr>
      <tr>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main"><?php echo tep_image(DIR_WS_IMAGES . 'arrow_green.gif') . ' <a href="' . tep_href_link(FILENAME_SPONSORSHIP_ADD, '', 'SSL') . '">' . MY_SPONSORSHIP_ADD . '</a>'; ?></td>
                  </tr>
                  <tr>
                    <td class="main"><?php echo tep_image(DIR_WS_IMAGES . 'arrow_green.gif') . ' <a href="' . tep_href_link(FILENAME_SPONSORSHIP_LIST, '', 'SSL') . '">' . MY_SPONSORSHIP_LIST . '</a>'; ?></td>
                  </tr>
                  <tr>
                    <td class="main"><?php echo tep_image(DIR_WS_IMAGES . 'arrow_green.gif') . ' <a href="' . tep_href_link(FILENAME_SPONSORSHIP_DISCOUNT, '', 'SSL') . '">' . MY_SPONSORSHIP_DISCOUNT . '</a>'; ?></td>
                  </tr>
                </table></td>
                <td width="10" align="right"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
