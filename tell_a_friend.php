...
<!-- header_eof //-->
<?php /*
<?php=sprintf(HEADING_TITLE, $product_info['products_name']);?>
*/?>
<!-- body //-->
...
<!-- body_text //-->
    <td width="100%" class="col_center"><?php echo tep_draw_form('email_friend', tep_href_link(FILENAME_TELL_A_FRIEND, 'action=process&products_id=' . $HTTP_GET_VARS['products_id'])); ?>
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
...
<?php echo tep_draw_infoBox_top();?>
                        ...
                        <table border="0" cellspacing="5" cellpadding="2">
						  <tr>
							...
							<td class="main"><?php echo tep_draw_input_field('from_name'); ?>&nbsp;<span class="inputRequirement">*</span></td>
						  </tr>
						  <tr>
							<td class="main"><?php echo FORM_FIELD_CUSTOMER_EMAIL; ?></td>
							<td class="main"><?php echo tep_draw_input_field('from_email_address'); ?>&nbsp;<span class="inputRequirement">*</span></td>
						  </tr>
						</table>
...
<?php echo tep_draw_infoBox_top();?>
                        ...
                        <table cellpadding="0" cellspacing="5" border="0" width="100%">
							<tr><td><?php echo tep_draw_textarea_field('message', 'soft', 40, 8); ?></td></tr>
						</table>
